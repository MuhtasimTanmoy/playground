<h2><a href="https://leetcode.com/problems/check-if-grid-satisfies-conditions/">3142. Check if Grid Satisfies Conditions</a></h2><h3>Easy</h3><hr><div><p>You are given a 2D matrix <code>grid</code> of size <code>m x n</code>. You need to check if each cell <code>grid[i][j]</code> is:</p>
