<h2>1566. Detect Pattern of Length M Repeated K or More Times</h2><h3>Easy</h3><hr><div><p>Given an array of positive integers <code>arr</code>, find a pattern of length <code>m</code> that is repeated <code>k</code> or more times.</p>
