<h2>2169. Count Operations to Obtain Zero</h2><h3>Easy</h3><hr><div><p>You are given two <strong>non-negative</strong> integers <code>num1</code> and <code>num2</code>.</p>
