<h2><a href="https://leetcode.com/problems/maximum-size-of-a-set-after-removals/">3002. Maximum Size of a Set After Removals</a></h2><h3>Medium</h3><hr><div><p>You are given two <strong>0-indexed</strong> integer arrays <code>nums1</code> and <code>nums2</code> of even length <code>n</code>.</p>
...
<pre><strong>Input:</strong> nums1 = [1,2,1,2], nums2 = [1,1,1,1]
...
<pre><strong>Input:</strong> nums1 = [1,2,3,4,5,6], nums2 = [2,3,2,3,2,3]
...
<pre><strong>Input:</strong> nums1 = [1,1,2,2,3,3], nums2 = [4,4,5,5,6,6]
