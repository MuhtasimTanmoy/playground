<h2><a href="https://leetcode.com/problems/count-pairs-of-points-with-distance-k/">2857. Count Pairs of Points With Distance k</a></h2><h3>Medium</h3><hr><div><p>You are given a <strong>2D</strong> integer array <code>coordinates</code> and an integer <code>k</code>, where <code>coordinates[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> are the coordinates of the <code>i<sup>th</sup></code> point in a 2D plane.</p>
