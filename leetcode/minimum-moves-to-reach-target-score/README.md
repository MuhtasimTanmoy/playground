<h2>2139. Minimum Moves to Reach Target Score</h2><h3>Medium</h3><hr><div><p>You are playing a game with integers. You start with the integer <code>1</code> and you want to reach the integer <code>target</code>.</p>
