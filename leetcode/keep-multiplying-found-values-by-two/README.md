<h2>2154. Keep Multiplying Found Values by Two</h2><h3>Easy</h3><hr><div><p>You are given an array of integers <code>nums</code>. You are also given an integer <code>original</code> which is the first number that needs to be searched for in <code>nums</code>.</p>
